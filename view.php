...
<body>
  ...
  $sql = "SELECT `ee_port_sts` AS `ee_sts`,TIMEDIFF((SELECT CURRENT_TIMESTAMP()),(SELECT `modified` FROM `dev_last_sts` WHERE `mob_no`='".$mobileNo."'))as `timeDiff` FROM `dev_last_sts` WHERE `mob_no`='".$mobileNo."'";
  ...
  //print_r($targetDev);
    ...
    if ($targetDev->num_rows > 0) {
      while($row = $targetDev->fetch_assoc()) {
        $EE_PRT_VAL = $row['ee_sts'];
        $time = explode(":", $row['timeDiff']);
      //print_r($time );
      }
    } else {
      echo "0 results";
    ...
    $conn->close();
    if ($time[1]>1) {
      $DEV_CONN_STS_FLG = "off";
      $SERIAL_PRT_FLG = 1; // value should be 0; But 1 used due to always availibility of serail panel.
      $IDU_EE_PRT_FLG = 0;
      $ODU_EE_PRT_FLG = 0;
    }else{
      $DEV_CONN_STS_FLG = "on";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class=\"card\">
              <div class=\"card-body\">
              <div class=\"row\"><img src=\"./assets/images/faces/".$DEV_CONN_STS_FLG.".png\" alt=\"\" width=\"100%\" height=\"50%\">
              </div>
              ...
              if($SERIAL_PRT_FLG == 1){
                ...
                <a class=\"nav-link\" href=\"serial.php?mobNo=".$mobileNo."\">
              ...
              if($IDU_EE_PRT_FLG == 1){
                ...
                <a class=\"nav-link\" href=\"iduEE.php?mobNo=". $mobileNo."\">
              ...
              if($ODU_EE_PRT_FLG == 1){
                ...
                <a class=\"nav-link\" href=\"oduEE.php?mobNo=".$mobileNo."\">
